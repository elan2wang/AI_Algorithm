...
for i = 1:k
    ...
    t_start = clock;
    % training
    [ite(i),w(i,:)] = perception_training(training_data);
    % calculate elapsed time
    elapsed_time(i) = etime(clock, t_start);
    % testing
    error_rate(i) = perception_testing(testing_data, w(i,:));
end
...
title('Figure 1: Error rate of Perceptron');
legend(str1);
hold off
...
title('Figure 2: Traing Time of Perceptron');
legend(str2);
hold off
